...
if($yj_item_type > 0  && $item->level > $allow_level && !empty($mod_subclass)){
   $class = 'class="yjanchor '.$first.$last.$aclass.$group_title.$dlevel1a.' yj_menu_module_holder '.$mod_subclass.'" ';
}elseif($yj_item_type > 0 && $item->level > $allow_level && empty($mod_subclass)){
   $class = 'class="yjanchor '.$first.$last.$aclass.$group_title.$dlevel1a.$mod_subclass.' yj_menu_module_holder" ';
}else{
   $class = 'class="yjanchor '.$first.$last.$aclass.$group_title.$dlevel1a.$mod_subclass.'" ';
}
