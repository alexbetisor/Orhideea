  ...
  <div class="catItemBody"> 
    ...
    <div class="catItemImageBlock" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;"> 
        <span class="catItemImage"> 
            ...
            <a class="modal yj_zoom" href="<?php echo $this->item->imageXLarge; ?>"></a>
            <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"> 
            <span class="yj_titcat">
                <span class="yj_title"><?php echo $this->item->title; ?></span>
                <span class="yj_category"><?php echo $this->item->category->name; ?></span>
            </span>
    ...
    <div class="yjk2_holder">
      ...
      <!-- Date created --> 
      <span class="catItemDateCreated"> <?php echo JHTML::_('date', $this->item->created , JText::_('YJ_DATE_FORMAT')); ?> </span>
      <?php endif; ?>
      <?php if($this->item->params->get('catItemAuthor')): ?>
      <!-- Item Author --> 
      <span class="catItemAuthor"> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?> <a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a> </span>
      <?php endif; ?>
      <?php if($this->item->params->get('catItemCategory')): ?>
      <!-- Item category name -->
      <div class="catItemCategory"> <span><?php echo JText::_('YJ_PUBLISHED_IN'); ?></span> <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a> </div>
      <?php endif; ?>
    ...
    <div class="yjk2_holder_right">
      ...
      <!-- Item "read more..." link -->
      <div class="catItemReadMore"> <a class="k2ReadMore" href="<?php echo $this->item->link; ?>"> <?php echo JText::_('YJ_READMORE'); ?> </a> </div>
      <?php endif; ?>
    </div>
    <div class="clr"></div>
