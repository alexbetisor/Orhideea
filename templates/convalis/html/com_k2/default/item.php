...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <div class="itemImageBlock" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;">
		  ...
		  <span class="itemImage">
		  	...
		  	<span class="yj_hover_effect itemview">
            ...
            <span class="yj_titcat">
                ...
                <span class="yj_title">Click to preview image</span>
  ...
  <div class="itemLinks">
		...
		<div class="itemCategory">
			...
			<span><?php echo JText::_('YJ_PUBLISHED_IN'); ?></span>
	  ...
	  <?php endif; ?>
		...
		<div class="itemContentFooter">
			...
			<span class="itemDateModified">
				...
				<?php echo JText::_('K2_LAST_MODIFIED_ON'); ?> <?php echo JHTML::_('date', $this->item->modified, JText::_('YJ_DATE_FORMAT')); ?>
