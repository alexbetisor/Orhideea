...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
  ...
  <div class="userBlock">
    ...
    <!-- Item add link --> 
    <span class="itemAddLink"> <a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->addLink; ?>"> <?php echo JText::_('K2_POST_A_NEW_ITEM'); ?> </a> </span>
    <?php endif; ?>
    ...
    <div class="itemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>"> 
      ...
      <div class="itemBody"> 
        ...
        <div class="itemImageBlock" style="width:<?php echo $item->params->get('itemImageGeneric'); ?>px; height:auto;"> 
            <span class="itemImage"> 
                <span class="yj_hover_effect">
                    <a class="modal yj_zoom" href="<?php echo $item->imageXLarge; ?>"></a>
                    <a href="<?php echo $item->link; ?>" title="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>"> 
                    <span class="yj_titcat">
                        <span class="yj_title"><?php echo $item->title; ?></span>
                        <span class="yj_category"><?php echo $item->category->name; ?></span>
                    </span>
        ...
        <div class="yjk2_holder">
          ...
          <!-- Date created --> 
          <span class="itemDateCreated"> <?php echo JHTML::_('date', $item->created , JText::_('YJ_DATE_FORMAT')); ?> </span>
          <?php endif; ?>
          <?php if($item->params->get('userItemCategory') || $item->params->get('userItemTags')): ?>
          <div class="itemLinks">
            <?php if($item->params->get('userItemCategory')): ?>
            <!-- Item category name -->
            <div class="itemCategory"> <span><?php echo JText::_('YJ_PUBLISHED_IN'); ?></span> <a href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a> </div>
            <?php endif; ?>
        ...
        <div class="yjk2_holder_right">
          <div class="itemHeader">
            ...
            <h3 class="itemTitle">
              ...
              <!-- Item edit link --> 
              <span class="itemEditLink"> <a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $item->editLink; ?>"> <?php echo JText::_('K2_EDIT_ITEM'); ?> </a> </span>
              <?php endif; ?>
          ...
          <!-- Item "read more..." link -->
          <div class="itemReadMore"> <a class="k2ReadMore" href="<?php echo $item->link; ?>"> <?php echo JText::_('YJ_READMORE'); ?> </a> </div>
          <?php endif; ?>
        </div>
        <div class="clr"></div>
